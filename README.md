...
> *"你的同事把屎山甩给你然后跑了，你的前任把项目搞烂了然后走了——但他们都忘了一件事：最后坐在工位上烂掉的那个人，不该是你。"*
...
你正在被同事甩锅、被前任留下的烂摊子折磨、被 deadline 追杀、被无尽的需求淹没。你坐在工位上 12 个小时，从颈椎痛到腰椎，从腰椎痛到灵魂。你不需要什么「30 天马甲线计划」——你需要的是**在被这堆破事压垮之前，有什么东西拉你一把**。
...
```bash
# 安装到全局（所有项目都能用）
git clone https://github.com/jyxc-dz-0100665/cyberfit ~/.claude/skills/cyberfit
...
你的同事把烂摊子甩给你然后跑了，你的前任留下一堆技术债让你还。**这些破事榨干了你的时间，但你的身体不该跟着一起报废。**
